...
public class VoiceListener extends ListenerAdapter {
	...
	private Boolean voiceServerDeaf = DiscordBot.config.getBoolean("DiscordBot.Listeners.VoiceServerDeaf");
	private Boolean voiceServerMute = DiscordBot.config.getBoolean("DiscordBot.Listeners.VoiceServerMute");
